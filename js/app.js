...
// Objects
// 	Let's set up an object data structure. Let's say we have a website 
//	that sells products, and we have a user of our website, and we want 
//	to store that user's data. The object data structure is a good way 
//	to organize the data from our user.

// 	A. Make a user object
// 	Create an object called user.
// 	Write into the object the key-value pairs for name, email, age, and 
//	purchased. Set the value of purchased to an empty array []. Set the 
//	other values to whatever you would like.

const user = {
	name: "Dude", 
	email: "someguy@gwiz.com",
	age: 30,
	purchased: [],
}
console.log(user);
...
user.email = "someSUPERguy@gwiz.com";
...
// 	D. Shopaholic!
// 	Our user has purchased an item! They have purchased some 
//	"carbohydrates". Using .push(), add the string "carbohydrates" 
//	to the purchased array.

user.purchased.push("carbohydrates");
console.log(user.purchased);

// 	Our user has purchased an item! They have purchased some "peace of 
//	mind". Using .push(), add the string "peace of mind" to the purchased 
//	array.

user.purchased.push("peace of mind");
console.log(user.purchased);

// 	Our user has purchased an item! They have purchased some "Merino 
//	jodhpurs". Using .push(), add the string "Merino jodhpurs" to the 
//	purchased array. Console.log just the "Merino jodhpurs" from the purchased array.
...
//	way that you can add any new property/value pair. If we want to give 
//	our user a friend with a name and age, we could write:
// 	user.friend = {
//     name: "Grace Hopper",
//     age: 85
// 	}
// 	When we console.log user, we would see the friend object added to our 
//	user object. Write a friend object into your user object and give the 
...
// 	The friend has purchased "The One Ring". Use .push() to add "The One 
//	Ring" to the friend's purchased array.

user.friend.purchased.push("The One Ring");
console.log(user.friend.purchased);

//  The friend has purchased "A latte". Use .push() to add "A latte" to 
//  the friend's purchased array. Console.log just "A latte" from the 
...
// 	Write a single function updateUser that takes no parameters. When the 
